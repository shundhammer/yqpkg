...
QString
YQPkgSelector::symHelp( const QString & imgFileName,
...
QString
YQPkgSelector::keyHelp( const QString & key,
                        const QString & summary,
                        const QString & explanation )
{
    QString html = "<tr valign='top'>";
...
QString
YQPkgSelector::para( const QString & text )
{
    return "<p>" + text + "</p>";
}
...
QString
YQPkgSelector::listItem( const QString & text )
{
    return "<li>" + text + "</li>";
}
