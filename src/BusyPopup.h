 ...
 * milliseconds so its own show, resize, move and paint events are processed.
 *
 * Usage:
 *
 ...
 *	   calc();
 *
 * In the normal case, just let the variable go out of scope, and the popup is
 * destroyed and thus closed. Of course you can also create it with 'new' and
 * destroy it with 'delete' or simply call 'hide()'.
 **/
